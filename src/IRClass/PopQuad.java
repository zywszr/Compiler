...
import static IRClass.Inst.POP;
...
public class PopQuad extends Quad {
    ...
    @Override public HashSet <Oprand> getDefined() {
        HashSet <Oprand> ret = new HashSet<>();
        return ret;
    }
    ...
    @Override public void replaceDefReg(HashMap <Oprand, Oprand> set) { }
}
